# Проектная работа 6. Профессия веб-разработичк. Яндекс.Практикум.
...
В данной работе реализована валидация полей форм с помощью Javascript.
...
Проектная работа доступна по адресу https://johnny983.github.iыo/mesto/
